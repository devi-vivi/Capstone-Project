...
def get_pie_chart(entered_site):
    ...
    if entered_site=='ALL':
        ...
        fail_count = site_df[site_df['class']==0].shape[0]
        fig = px.pie(values=[success_count,fail_count],
        names=['Success','Failure'],
        title="Total success and failure for {}".format(entered_site))
        return fig
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site=='ALL':
        ...
        title='Correlation between Payload and Succes for {}'.format(entered_site))
        return fig
